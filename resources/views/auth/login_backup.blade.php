...
<head>
	...
	<!-- Stylesheet -->
	<link rel="stylesheet" href="{{ asset('backend/vendors/css/base/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ asset('backend/vendors/css/base/elisyam-1.5.css') }}">
	...
	<body class="bg-white">
		...
		<div id="preloader">
			<div class="canvas">
				<img src="{{ asset('backend/img/logo.png') }}" alt="logo" class="loader-logo">
		...
		<!-- End Container -->    
		<!-- Begin Vendor Js -->
		<script src="{{ asset('backend/vendors/js/base/jquery.min.js') }}"></script>
		<script src="{{ asset('backend/vendors/js/base/core.min.js') }}"></script>
		<!-- End Vendor Js -->
		<!-- Begin Page Vendor Js -->
		<script src="{{ asset('backend/vendors/js/app/app.js') }}"></script>
		<script src="{{ asset('backend/vendors/js/nicescroll/nicescroll.min.js') }}"></script>
		<!-- End Page Vendor Js -->
	</body>
	</html>